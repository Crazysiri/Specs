...
'FRAMEWORK_SEARCH_PATHS' => '$(inherited) $(PODS_CONFIGURATION_BUILD_DIR)/Masonry $(PODS_CONFIGURATION_BUILD_DIR)/UIViewController_iconAndTip $(PODS_CONFIGURATION_BUILD_DIR)/SDWebImage',
}
